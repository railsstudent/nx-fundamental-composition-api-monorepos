...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/YJELqZtDzs)
...
```sh
npx nx serve fundamental-composition-api
```

To create a production bundle:

```sh
npx nx build fundamental-composition-api
```

To see all available targets to run for a project, run:

```sh
npx nx show project fundamental-composition-api
```
